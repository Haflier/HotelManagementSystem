        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasEmptyRoom = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FactorItem_Factor_FactorId",
                        column: x => x.FactorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FactorItemId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_FactorItem_FactorItemId",
                        column: x => x.FactorItemId,
                        principalTable: "FactorItem",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ChosenRoom = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservation_FactorItem_FactorItemId",
                        column: x => x.FactorItemId,
                        principalTable: "FactorItem",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FactorItem_OrderId",
                table: "FactorItem",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_FactorItem_ReservationId",
                table: "FactorItem",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservation_FactorItemId",
                table: "Reservation",
                column: "FactorItemId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FactorItem_Order_OrderId",
                table: "FactorItem",
                column: "OrderId",
                principalTable: "Order",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FactorItem_Reservation_ReservationId",
                table: "FactorItem",
                column: "ReservationId",
